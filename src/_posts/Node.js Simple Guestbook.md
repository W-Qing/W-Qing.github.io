...
tags: 
  - Node.js
title: 'Node.js实现简单的留言本'
description: '利用Node.js服务器写一个简单的留言本'
date: 2018-05-18
vssue-title: 'Node.js实现简单的留言本'
---
...
[![目录结构](http://owoccema2.bkt.clouddn.com/diagrams/node/tree.png)](http://owoccema2.bkt.clouddn.com/diagrams/node/tree.png)

- 为了方便的统一处理要用到的静态资源，把所有的静态资源都存放在 public 目录中
- 为了让目录结构保持统一清晰，把所有的 HTML 文件都放到 views（视图） 目录中
...
- [完整代码](https://github.com/W-Qing/Code/tree/master/Node.js/guestbook)